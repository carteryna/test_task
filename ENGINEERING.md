# Aerial vehicle detection — engineering log

Companion to the [submission README](README.md). This file is the full pipeline notebook: every threshold probe, command, and decision behind the numbers in the brief.
...
| Strategy + key decisions | [README.md](README.md) (brief) and sections below (full log) |
...
| Trained weights or a link | `runs/train/yolo11n/weights/best.pt` (clean labels) and `runs/train/yolo11n_dinosam/weights/best.pt` (factory labels) are gitignored (`*.pt`); upload to Drive/S3/HF and put the URL in [README.md](README.md) or the repo description |
